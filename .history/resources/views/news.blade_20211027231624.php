    ...
    <div class="container px-5 py-8 mx-auto">
      ...
      <div class="flex flex-wrap justify-between">
          @foreach ($news as $berita)
            <div class="xl:w-1/3 md:w-1/2 p-4 filter drop-shadow-2xl flex">
                <div class="bg-white p-6 rounded-lg max-h-full w-full">
                <img class="lg:h-full xl:h-full md:h-full sm:h-full h-20 rounded w-full object-cover object-center mb-6" src="http://kbmti.filkom.ub.ac.id/public/storage/articles/614c8eea93282_partnership3_01.jpg" alt="Image Size 720x400">
