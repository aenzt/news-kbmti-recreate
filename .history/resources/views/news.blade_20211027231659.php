      ...
      <div class="flex flex-wrap justify-between">
          @foreach ($news as $berita)
            <div class="xl:w-1/3 md:w-1/2 p-4 filter drop-shadow-2xl flex">
                ...
                <img class="h-5 rounded w-20 object-cover object-center mb-6" src="http://kbmti.filkom.ub.ac.id/public/storage/articles/614c8eea93282_partnership3_01.jpg" alt="Image Size 720x400">
