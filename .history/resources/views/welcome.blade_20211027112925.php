      ...
      <div class="flex flex-wrap -m-4">
        <div class="xl:w-1/3 md:w-1/2 p-4">
          <div class="bg-white p-6 rounded-lg">
            <img class="lg:h-full xl:h-full md:h-full sm:h-full xs:h-72 h-full  rounded w-full object-cover object-center mb-6" src="http://kbmti.filkom.ub.ac.id/public/storage/articles/614c8eea93282_partnership3_01.jpg" alt="Image Size 720x400">
